...
export const EventCard = ({
  ...
  return (
    <Link href={'/calendar/event'}>
      <div
        className={clsx(
          'hidden lg:block bg-bgWhite p-[60px] rounded-[2px] cursor-pointer transition-all w-full greenBtnShadow hover:hover-shadow',
          {
        ...
        <div className="flex items-start gap-x-[33px]">
          ...
          <div className="flex flex-col items-start gap-x-[25px] max-w-[683px]">
            ...
            <p className="uppercase text-gray mb-[10px] text-[10px]">{organizer}</p>
      ...
      <div
        className={clsx(
          'lg:hidden bg-bgWhite px-4 py-6 rounded-[2px] cursor-pointer transition-all greenBtnShadow',
          {
            'bg-navyBlue text-gray': dark,
          },
        )}>
        <div className="flex-col items-start gap-x-[33px]">
          <div className="flex flex-col items-start gap-[10px]">
            <div className="border-b-[1px] border-[#DFE9F2] w-full pb-[20px]">
              <p
                className={clsx('text-[16px] leading-[125%] font-semibold mb-[10px]', {
                  'text-red': !dark,
                  'text-lightYellow': dark,
                })}>
                {date}
            ...
            <Image src={img} width={150} height={150} alt="Event Image" className="mx-auto" />
            <div className="flex flex-col items-start gap-x-[25px] max-w-[683px]">
              <p className="text-[12px] uppercase text-gray mb-[10px]">{suptitle}</p>
              <h3
                className={clsx('text-[21px] mb-[10px] font-bold leading-[115%]', {
                  'text-bgWhite': dark,
                  'text-green': !dark,
                })}>
                {title}
              ...
              <p className="uppercase text-gray mb-[5px] text-[10px]">{organizer}</p>
              <p className="text-gray text-[12px] leading-[100%]">{footerText}</p>
            </div>
          </div>
        </div>
      </div>
