    ...
    <div className="mb-[100px]">
      <div className="container flex flex-col items-start pt-[20px] gap-12">
        <div>
          ...
          <h2 className="text-extra font-semibold leading-[100%]">Календарь мероприятий</h2>
        </div>
        ...
        <div className="w-full flex flex-col gap-6 items-center justify-center">
          ...
          <div className="flex items-center gap-5">
            <button
              onClick={() => router.push(`/events/?page=${Number(page) - 1}&per_page=${per_page}`)}
              ...
              <svg
                ...
                <path d="M18 22L12 16L18 10L19.4 11.4L14.8 16L19.4 20.6L18 22Z" fill="#5D6A77" />
              </svg>
            </button>
            <Pagination />
          </div>
