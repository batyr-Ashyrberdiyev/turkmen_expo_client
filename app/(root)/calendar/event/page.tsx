                  ...
                  <div className="flex w-full gap-[45px]">
                    <div className="flex gap-[15px]">
                      <div className="w-[220px] h-[180px] bg-gray4 py-[10px] px-[33px] flex justify-center items-center">
                        <Image src={glassIcon} width={154} height={160} alt="Иконка" className="" />
                      </div>
                    ...
                    <div className="flex flex-col w-full max-w-[238px] mt-[40px]">
                      ...
                      <div className="flex items-center gap-[10px]">
                        ...
                        <p className="text-gray4">Добавить в календарь (ics файл)</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mt-[60px] mb-[100px]">
          <div className="flex flex-col gap-[60px]">
            {fullEventData
              ...
              .map((item) => (
                <div key={v4()}>
                  <p className="mb-[40px] leading-[100%] text-[21px] font-semibold">{item.title}</p>
                  <div className="flex gap-[20px]">
                    {item.info?.map((text) => (
                      <div key={v4()} className="w-full max-w-[290px] flex flex-col gap-[20px]">
            ...
            <div className="flex flex-col gap-[33px]">
              {fullEventData
                ...
                .map((obj) => (
                  <>
                    <h3 key={v4()} className="text-[21px] leading-[100%] font-semibold">
                      {obj.title}
                    </h3>
                    {obj.info?.map((text) => (
